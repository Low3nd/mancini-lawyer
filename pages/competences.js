              ...
              <div className={styles["skill-content"]}>
                <div>
                  <p>
                    ...
                    MANCINI vous assiste dès le début de l&apos;enquête et à tous
                    les stades de la procédure.
                  </p>
                  <p>
                    Du dépôt de plainte ou de la garde à vue, au renvoi devant le
                    juridiction compétente, en passant par l&apos;ouverture
                    d&apos;une information judiciaire devant le juge
                    d&apos;instruction, le cabinet saura vous soutenir et établir
                    la stratégie nécessaire au bon déroulé de votre affaire.
                  </p>
                  <p>
                    Maître MANCINI est par ailleurs formée à l&apos;accompagnement
            ...
            <div id="etrangers" className={`${styles["skill"]}`}>
              ...
              <div className={styles["skill-content"]}>
                <p>
                  ...
                  votre dossier.<br />A ce stade, obtenir des conseils juridiques est
            ...
            <div id="civile" className={`${styles["skill"]}`}>
              ...
              <div className={styles["skill-content"]}>
                <p>
                  ...
                  d&apos;échec ou de refus de tout cadre amiable, elle engagera
                  l&apos;action en responsabilité adéquate et vous accompagnera
                  tout au long de la procédure, notamment durant la phase
