...
import skill from '../JSON/component.JSON';
          ...
          <div className={styles['c-hero__logo']}>
            <svg viewBox="0 0 102 102" fill="none" xmlns="http://www.w3.org/2000/svg">
              <symbol id="test" width="102" height="102" viewBox="0 0 102 102"></symbol>
                <path d="M51 101C78.6142 101 101 78.6142 101 51C101 23.3858 78.6142 1 51 1C23.3858 1 1 23.3858 1 51C1 78.6142 23.3858 101 51 101Z" stroke="currentcolor" stroke-miterlimit="10"/>
